...
int main()
{
	...
	bool t1= 1;
	cout << "Testing branch and Get Node"<<endl;

	if(t.get_node(1)->latest_data != "A();"){
		t1 =0;
	} else {
	    //cout<<t.get_node(1)->latest_data<<endl;
		cout << ".";
	}
	if(t.get_node(11)->latest_data != "A();B();"){
		t1 =0;
	} else {
	    //cout<<t.get_node(11)->latest_data<<endl;
		cout << ".";
	}
	if(t.get_node(113)->latest_data != "A();B();G();"){
		t1 =0;
	} else {
	    //cout<<t.get_node(113)->latest_data<<endl;
		cout << ".";
	}
	if(t.get_node(121)->latest_data != "A();C();H();"){
		t1 =0;
	} else {
	    //cout<<t.get_node(121)->latest_data<<endl;
		cout << ".";
	}

    //cout<<t.get_node(21)<<endl;
	if(t.get_node(21) != 0){
		t1 =0;
	} else {

	    //cout<<t.get_node(21)->latest_data<<endl;
		cout << ".";
	}
	...
	if(t.get_node(1234) != 0){
	    ...
	    //cout<<t.get_node(1234)->latest_data<<endl;
		cout << ".";
	}
	...
	// tree traversal
	cout<<endl;
    cout << "---- level order tree traversal -------- " << endl<<endl;
